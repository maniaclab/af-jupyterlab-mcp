"""Command-line interface for jupyterlab-mcp."""
...
from jupyterlab_mcp.server import serve


def main() -> None:
    """Entry point for the jupyterlab-mcp command."""
    ...
    serve_parser.add_argument(
        "--audience",
        default="jupyterlab-mcp",
        help="Expected aud claim of broker-issued JWTs (default: jupyterlab-mcp)",
    )
    serve_parser.add_argument(
        "--resource-url",
