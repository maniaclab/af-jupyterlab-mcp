"""MCP server setup for jupyterlab-mcp.
...
from jupyterlab_mcp.auth.broker import make_broker_token_verifier, make_broker_verifier
from jupyterlab_mcp.config import Settings
from jupyterlab_mcp.k8s.notebooks import K8sClients
from jupyterlab_mcp.tools import jupyterlab as jupyterlab_tools
...
def serve(
    ...
    if not broker_url:
        sys.stderr.write(
            "[jupyterlab-mcp] Error: serve requires --broker-url "
