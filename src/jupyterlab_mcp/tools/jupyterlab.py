...
from jupyterlab_mcp.auth.broker import get_broker_claims
from jupyterlab_mcp.config import DURATION_HOURS_DEFAULT
from jupyterlab_mcp.k8s import gpu as gpu_mod
from jupyterlab_mcp.k8s import notebooks as notebooks_mod
...
from jupyterlab_mcp.tools._helpers import (
    append_next_actions,
    format_error,
    format_notebook,
...
def register(mcp: MCPServer) -> None:
    """Register the six jupyterlab-mcp tools on *mcp*."""
