...
*/}}
{{- define "jupyterlab-mcp.fullname" -}}
...
Common labels
*/}}
{{- define "jupyterlab-mcp.labels" -}}
helm.sh/chart: {{ include "jupyterlab-mcp.chart" . }}
{{ include "jupyterlab-mcp.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
app.kubernetes.io/name=jupyterlab-mcp continue to match.
*/}}
{{- define "jupyterlab-mcp.selectorLabels" -}}
app.kubernetes.io/name: {{ include "jupyterlab-mcp.name" . }}
...
*/}}
{{- define "jupyterlab-mcp.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "jupyterlab-mcp.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "jupyterlab-mcp.validate" -}}
...
*/}}
{{- define "jupyterlab-mcp.resourceUrl" -}}
...
{{/*
Build the `jupyterlab-mcp serve` argv as YAML list items (one `- "value"`
...
its own argv entry.
*/}}
{{- define "jupyterlab-mcp.serveArgs" -}}
{{- include "jupyterlab-mcp.validate" . -}}
{{- $args := list "serve"
...
{{- $args = append $args . -}}
{{- end -}}
{{- with (include "jupyterlab-mcp.resourceUrl" .) -}}
