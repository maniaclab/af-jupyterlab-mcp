...
class TestPortalUrl:
    ...
    def test_portal_url_set_from_env(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        monkeypatch.setenv("JUPYTERLAB_MCP_PORTAL_URL", "https://af.uchicago.edu/jupyterlab")
        s = Settings.from_env()
        assert s.portal_url == "https://af.uchicago.edu/jupyterlab"

    def test_portal_url_absent_from_env_gives_none(self, monkeypatch: pytest.MonkeyPatch) -> None:
