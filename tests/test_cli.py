"""Tests for the af-jupyterlab-mcp CLI argument wiring."""

from __future__ import annotations

from unittest.mock import patch

from af_jupyterlab_mcp.cli import main


class TestCliServe:
    def test_serve_forwards_broker_url(self) -> None:
        with (
            patch("af_jupyterlab_mcp.cli.serve") as mock_serve,
            patch(
                "sys.argv",
                [
                    "af-jupyterlab-mcp",
        ...
        assert kwargs["audience"] == "af-jupyterlab-mcp"
    ...
    def test_serve_forwards_all_broker_overrides(self) -> None:
        with (
            ...
            patch(
                ...
                [
                    ...
                    "custom-aud",
                    "--resource-url",
                    "https://af-jupyterlab-mcp.invalid",
                    "--host",
                    "127.0.0.1",
                    "--port",
                    "9000",
        ...
        assert kwargs["resource_url"] == "https://af-jupyterlab-mcp.invalid"
        assert kwargs["host"] == "127.0.0.1"
        assert kwargs["port"] == 9000

    def test_no_command_prints_help(self) -> None:
        with patch("sys.argv", ["af-jupyterlab-mcp"]):
            main()
